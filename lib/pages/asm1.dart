...
class AssesmentPage1 extends StatefulWidget {
  AssesmentPage1({super.key});

  @override
  State<AssesmentPage1> createState() => _AssesmentPage1State();
}

class _AssesmentPage1State extends State<AssesmentPage1> {
  // Variable
    ...
    return Scaffold(
      backgroundColor: Color.fromRGBO(248, 248, 248, 1),
        ...
        child: Column(
          ...
          children: [
            Text(
              "Do you know how significant the negative impact of food waste is on the environment and the economy?",
